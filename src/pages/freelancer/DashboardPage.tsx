          ...
          <>
            ...
            <div className="mt-6 grid gap-5 lg:grid-cols-[1.4fr_1fr]">
                ...
                <div className="mt-4 h-60">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
                      ...
                      />
                      <Bar dataKey="propostas" fill="oklch(0.55 0.22 268)" radius={[6, 6, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </Card>
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <h2 className="font-display text-lg font-semibold">Vagas recomendadas</h2>
                  <Link
                ...
                <div className="mt-4 space-y-3">
                  {(recommendedQuery.data ?? []).slice(0, 3).map((p) => (
                    <Link
                      ...
                      className="block rounded-lg border bg-surface p-4 transition-all hover:shadow-sm"
                    >
            ...
            <Card className="mt-6 overflow-hidden">
              <div className="flex items-center justify-between p-5">
                <h2 className="font-display text-lg font-semibold">Candidaturas recentes</h2>
                <Link
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-t bg-surface-muted text-left text-xs uppercase tracking-wider text-muted-foreground">
